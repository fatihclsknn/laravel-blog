    ...
    <div class="row s-header__content">
        ...
        <nav class="s-header__nav-wrap">
            ...
            <ul class="s-header__nav">
                <li class="current"><a href="{{ route('front.homePage') }}" title="">Ana Sayfa</a></li>
                ...
                <li><a href="{{ route('front.about') }}" title="">Hakkımızda</a></li>
                <li><a href="{{ route('front.contact') }}" title="">İletisim</a></li>
            </ul> <!-- end header__nav -->
